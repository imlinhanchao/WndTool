...
bool Ini::GetAllSections(std::vector<CString>& sSections )
{
...
bool Ini::GetAllKeys( CString sSection, std::vector<CString>& sKeys )
{
	const int nBufferSize = 102400;
	TCHAR szValue[nBufferSize] = {0};
...
bool Ini::Read( CString sSection, CString sKeyName, ULONGLONG& dwValue )
{
	CString sValue;
