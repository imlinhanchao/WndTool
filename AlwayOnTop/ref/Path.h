...
public:
	...
	*/
	 ...
	 * @return CString The final path
	 */
	static int CopyTo(std::vector<CString> lstSrc, CString sDst);
	 ...
	 * @return CString The final path
	 */
	static std::vector<CString> Traversing(CString sDirectory, FILITER filter=NULL);
	 ...
	 * @return CString The final path
	 */
	static std::vector<CString> GetFileList(CString sDirectory, CString sFormat=_T("*"));
